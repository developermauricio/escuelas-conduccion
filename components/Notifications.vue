      ...
      <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
        <li class="dropdown-menu-header">
          <div class="dropdown-header d-flex">
            ...
            <div class="badge rounded-pill badge-light-primary">6 Nuevos</div>
          </div>
        </li>
...
<!--            <div class="me-1">-->
<!--              &lt;!&ndash;                  <div class="avatar"><img src="/app-assets/images/portrait/small/avatar-s-15.jpg" alt="avatar" width="32" height="32"></div>&ndash;&gt;-->
<!--            </div>-->
...
<!--          <div class="list-item d-flex align-items-start">-->
<!--            <div class="me-1">-->
<!--              &lt;!&ndash;                  <div class="avatar"><img src="/app-assets/images/portrait/small/avatar-s-3.jpg" alt="avatar" width="32" height="32"></div>&ndash;&gt;-->
<!--            </div>-->
<!--            <div class="list-item-body flex-grow-1">-->
...
<!--          </a>-->
<!--        </li>-->
        <li class="dropdown-menu-footer"><a class="btn btn-primary w-100" href="#">Ver todas las notificaciones</a></li>
      </ul>
    </li>
  </div>
</template>
